    ...
    <div className="d-flex justify-content-center align-items-center vh-100" style={{ backgroundColor: "#f8f9fa", fontFamily: "Poppins, sans-serif" }}>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            <input name="name" placeholder="Full Name" onChange={handleChange} className="form-control p-3 fw-bold rounded-3 shadow-sm" required />
          </div>
          <div className="mb-3">
            <input name="email" type="email" placeholder="Email Address" onChange={handleChange} className="form-control p-3 fw-bold rounded-3 shadow-sm" required />
          </div>
          <div className="mb-3">
